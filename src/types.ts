...
export interface AppState { schemaVersion: number; positions: Position[]; settings: Settings; notification: { authenticated: boolean; user?: string; error?: string }; updatedAt: string; serverTime: string }
